...
const ProductDetails = ({ match }) => {
    ...
    const addToCart = () => {
        if (product.stock <= 0) {
            ...
            document.getElementById('cart_btn').innerHTML = `<del>Thêm vào giỏ hàng</del>`;
        }
        else {
                ...
                <Fragment>
                    ...
                    <div className="row d-flex justify-content-around">
                        ...
                        <div className="col-12 col-lg-5 mt-5">
                            ...
                            <button type="button" id="cart_btn" className="btn btn-primary d-inline ml-4" onClick={addToCart}>Thêm vào giỏ hàng</button>
