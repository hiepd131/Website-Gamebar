...
const Cart = ({ history }) => {
    ...
    return (
        <Fragment>
            ...
            {cartItems.length === 0 ?
            // cart is empty
            <div className="col-sm-12 empty-cart-cls text-center d-flex justify-content-center align-items-center" style={{minHeight: "calc(100vh - 430px)"}}>
            <div className="d-flex flex-column align-items-center">
              ...
              <h4>Hãy thêm mới một sản phẩm vào giỏ hàng rồi quay lại nhé!</h4> 
